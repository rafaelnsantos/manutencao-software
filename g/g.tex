...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{./imagens/paginas.png}
	\caption{Diagrama de caso de uso}
	\label{fig:casoDeUso}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{./imagens/envio_qualquer_arquivo.png}
	\caption{Diagrama de caso de uso}
	\label{fig:casoDeUso}
\end{figure}
...
7. Sem nome de usuário na tela principal
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{./imagens/paginas.png}
	\caption{Diagrama de caso de uso}
